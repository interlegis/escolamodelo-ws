...
@conversa1 = ContactUsConversation.create(type_conversation: "dúvida", title: "Não consigo acessar o moodle", was_answered: "false", school_initials: "SSL", course_id: "1", description: "O que fazer para ter acesso as aulas", cpf: "0452285554", name: "Morfeus", email: "MorfeusNeo@gmail.com")
ContactUsConversation.create(type_conversation: "reclamação", title: "O site apresenta um layout muito desagradável", was_answered: "false", school_initials: "HTT", course_id: "2", description: "O design do site poderia ser mudado para um modelo parecido com o do facebook.", cpf: "123123132", name: "Rezinaldo", email: "reizão@gmail.com")
ContactUsConversation.create(type_conversation: "sugestão", title: "Melhorar o curso de Web", school_initials: "SSL", was_answered: "false", course_id: "1", description: "O curso de web poderia apresentar a linguagem javascript.", cpf: "0452285554", name: "Zilmar", email: "Zilmar@gmail.com")
ContactUsConversation.create(type_conversation: "dúvida", title: "Posso passar a senha do meu moodle para um amigo?", was_answered: "false", school_initials: "SSL", course_id: "1", description: "Gostaria de saber se eu posso passar a senha do moodle para que um amigo também possa participar das atividades.", cpf: "0452285554", name: "Sassá", email: "sassa@gmail.com")
