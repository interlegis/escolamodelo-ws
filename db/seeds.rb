...
s.logo.attach(
    io: StringIO.new('https://saberes.senado.leg.br/images/logo_saberes_xl.png'),
    filename: 'logo_saberes.png',
    content_type: 'image/png'
)
s=School.create(name: 'Saberes', url: 'https://saberes.senado.leg.br')
s.logo.attach(
    io: StringIO.new('https://saberes.senado.leg.br
...
s.logo.attach(
    io: StringIO.new('http://ead.almg.gov.br/moodle/theme/image.php/fadeback/theme/1479830583/logo'),
    filename: 'logo_almg.png',
    content_type: 'image/png'
)
s=School.create(name: 'EaD Senac', url: 'http://www.ead.senac.br/')
s.logo.attach(
    io: StringIO.new('http://folhadealagoas.com.br/portal/wp-content/uploads/2017/08/senac.jpg'),
    filename: 'logo_senac.png',
    content_type: 'image/png'
)
cat=CourseCategory.create(name: 'Meio Ambiente')
cat.logo.attach(
    io: StringIO.new('https://static.todamateria.com.br/upload/te/rr/terra1.jpg'),
    filename: 'logo_cat_meio_ambiente.jpg',
    content_type: 'image/png'
)
cat=CourseCategory.create(name: 'Saúde')
cat.logo.attach(
    io: StringIO.new('http://envolverde.cartacapital.com.br/wp-content/uploads/saude-1.jpg'),
    filename: 'logo_cat_saude.jpg',
    content_type: 'image/png'
)
cat=CourseCategory.create(name: 'Doutrinas Políticas')
cat.logo.attach(
    io: StringIO.new('https://2.bp.blogspot.com/-4JP1mOWw2bk/WOqMTDF4keI/AAAAAAABR6g/dF8hEdmDoL8wH-Iz1VhQsyGFqGheiT0uACLcB/s1600/%252BPostagem%2B046.jpg'),
